...
public class ImportService {
    ...
    public ClearResult clearImportedData(Long tenantId, Long propertyId) {
        int deletedExpenses = expenseRepo.deleteAutoGeneratedByTenantAndProperty(tenantId, propertyId);
        int deletedBookings = bookingRepo.deleteByTenantIdAndPropertyId(tenantId, propertyId);
